...
class TradeRejectList extends React.Component{
  constructor() {
    super();
  ...
  render() {
    ...
    let {loading,loadingMore,tradeReInquList} = dataSource;
    if(tradeReInquList&&tradeReInquList.length>0) {
      return (<div style={{ width: '100%' }}>
        <ListView
          dataSource={this.state.ds.cloneWithRows(tradeReInquList?tradeReInquList:[])}
...
export default TradeRejectList;
