...
class RebutRedeem extends React.Component{
  ...
  const titleProps = {
    title:rejectFlag=='0'?'转换驳回详情':'基金转换详情',
  };
  const pushTitle= {
    fileTitle:'基金转换申请单'
  }
  ...
  return (
         ...
         <WhiteSpace/>
          ...
          <WhiteSpace/>
           ...
           <WhiteSpace/>
            ...
            <WhiteSpace/>
             <List>
               <Item extra={tradInfo.reqShr}>转换份额</Item>
               <Item extra={tradInfo.targProdName + '-' + tradInfo.targShrType}>转入产品</Item>
               <Item extra={tradInfo.avlShr}>可用份额</Item>
               <Item extra={tradInfo.remitDate}>转换日期</Item>
               <TextareaItem title='转换原因' autoHeight  value={tradInfo.remark}/>
             </List>
             {
    ...
    {rejectFlag=='0'?( <div className={redeemStyles.footerSec}>
       ...
       <div className={redeemStyles.p} onClick = {()=>{
               ...
               dispatch(routerRedux.push({pathname:'/TradeFundCChange',state:{
                       data:data,
