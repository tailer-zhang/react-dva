...
import FundChangeAskTabs from '../../components/share/FundChangeAskTabs';
...
class FundChangeAsk extends React.Component{
  constructor(props) {
    super(props);
  }
    ...
    return (
      <div className={tradeInfo.tradeInfo}>
        ...
        <div style={{backgroundColor:'#efeff4'}}>
          <FundChangeAskTabs formStorage={formStorage} customer={customer} form={form} tradeForm={tradeForm} dispatch={dispatch} onChangeMethord={this.onChangeMethord.bind(this)} askInfo={askInfo}/>
        </div>
      </div>);
      }
    };
...
export default connect(connectTradeFun)(createForm()(FundChangeAsk));
